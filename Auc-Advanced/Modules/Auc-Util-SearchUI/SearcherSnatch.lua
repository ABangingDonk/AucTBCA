...
function private.ClickLinkHook(link, button)
...
if ChatFrameMixin and ChatFrameMixin.OnHyperlinkClick then
	-- 2.5.5+ (TBC Classic Anniversary)
	hooksecurefunc(ChatFrameMixin, "OnHyperlinkClick", function(self, link, text, button)
		private.ClickLinkHook(link, button)
	end)
